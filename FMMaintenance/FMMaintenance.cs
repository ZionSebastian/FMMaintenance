...
namespace FMMaintenance
{
    ...
    public class FMMaintenance : B1AddOn
    {

        public FMMaintenance()
        {
        ...
        public static void Main()
        {
            ...
            try
            {
                            ...
                            || (cnxType == B1WizardBase.B1Connections.ConnectionType.MultipleAddOns)))
                {
                    ...
                    //FMMaintenance_Db addOnDb = new FMMaintenance_Db();
                    //addOnDb.Add(B1Connections.diCompany);
                    //FMMaintenance_Cockpits addOnCockpit = new FMMaintenance_Cockpits();
                    //addOnCockpit.Manage(B1Connections.theAppl, B1Connections.diCompany);


                }
                // CREATE ADD-ON
                FMMaintenance addOn = new FMMaintenance();
